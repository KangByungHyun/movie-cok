    ...
    try:
        ...
        for i in range(start_code, finish_code):
            ...
            for a, m in enumerate(movie):
                ...
                sheet.append([code, title.text, genre_str, nation_str, playtime.text, directors_str, actors_str, age.text, date_str, summary_str, image])
                ...
                '''
                # (8) 영화포스터 수집
                # img_src = m.select_one("div.mv_info_area div.poster a img")
                # if(img_src == None):
                    # is_ok = False
                    # continue
        ...
        print("에러발생")
        wb.save("navermovie_basic2.xlsx")
    finally:
        print("완료")
        wb.save("navermovie_basic2.xlsx")